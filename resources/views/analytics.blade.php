...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Track your productivity and task completion metrics</p>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-green-600 mt-1">62.5% completion rate</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-yellow-600 mt-1">16.7% of total</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Task Priority Distribution</h3>
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-gray-600">High Priority</span>
                            <span class="font-medium">8 tasks</span>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            ...
                            <span class="font-medium">12 tasks</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            ...
                            <span class="font-medium">4 tasks</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
